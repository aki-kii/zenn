...
コード補完を利用すれば、打ち間違いも少なくなるしどのようなプロパティがあるのかをドキュメントなしで探せます。

### ドキュメントがすぐ読める

プロパティにどんな値を指定すればいいかわからない時、ドキュメントを確認すると思います。\
IDE では、オブジェクトにホバーすればドキュメントが見れます。

![alt text](/images/cdks-recommended-points/documentation.png)

わざわざドキュメントを開かずとも説明が読めるので、時間を短縮できます。
